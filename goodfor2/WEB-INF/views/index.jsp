			...
			<div class="info" style="position: relative; z-index: 0; background: none;">
				<div class="container" style="top: 18%;">
					<div class="row">
						...
						<div class="col-full"><h1 style="margin-top: 100px;">김세호</h1></div>
			...
			<div class="container" style="width : 70%">
				...
				<div class="row section-content">
					<div class="col-1-3" style="text-align: center;">
						<img src="resources/img/seho.jpg" style="height: 200px;" src="">
					</div>

					<div class="col-1-3">
						<h4>안녕하세요?</h4>
						<p>저는 개발자를 시작하는 사람입니다. 시작하면서 만든 프로젝트를 아래 포트폴리오로 만들었으니 <a href="#portfolio">여기를 누르시거나</a> 페이지 아래쪽에서 구경해 보세요! 더 궁금하신 사항은 <a href="#contact">이메일</a>로 연락해 주세요.</p>
					 ...
					 <div class="col-1-3">
						<h4>개인 관심사</h4>
						<p><a href="#skills">프로그래밍</a>을 하지 않을 때는 다음과 같은 취미를 통해 즐거운 생활을 하고 있답니다.</p>
						<ul>
							<li>장편소설을 읽는걸 좋아합니다.</li>
							<li>비오는날 카페에서 창 밖을 보는걸 좋아합니다.</li>
				...
				<div class="row section-content">
					...
					<div class="row projects gallery" style="margin-left: 320px;">
						<div class="col-1-6 project port-application mix_all" style="display: inline-block;  opacity: 1; padding-top: 30px;">
							<a id="project" href="#">
								<img src="<%=application.getContextPath()%>/resources/img/goodfor.JPG" alt="project">
							</a>
						</div>
						<div class="col-1-6 project port-game mix_all" style="display: inline-block;  opacity: 1; padding-top: 30px;">
							<a href="https://github.com/kimseho91?tab=repositories" title="github" >
					...
					<div class="col-2-3 col-wrap centered text-center">
						<div class="row">
							<div class="col-full" style="margin-bottom: 25px;">
								...
								않고 하루하루 성장하겠습니다  <br>picob@naver.com으로 이메일 주세요. 곧 답장 드리겠습니다.<br>언제든지 연락주세요	
							</div>
						</div>
